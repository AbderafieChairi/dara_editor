        ...
        <div>
          <button
            aria-label={i18n.translate(
              'opensearch-dashboards-react.exitFullScreenButton.exitFullScreenModeButtonAriaLabel',
              {
              ...
              <EuiFlexItem grow={false} data-test-subj="exitFullScreenModeText">
                <div>
                  <EuiText size="s" className="dshExitFullScreenButton__text">
                    <p>
                      {i18n.translate(
                        'opensearch-dashboards-react.exitFullScreenButton.exitFullScreenModeButtonText',
                        {
